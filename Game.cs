...
namespace Generalized_Backup_Tool
{
    ...
    class Game
    {
        ...
        public bool usesSteamPath;          // If this is set to false, the savePath will be taken literally.

        public Game(string name, string path, string proName, List<string> sNames, bool useSteam)
        {
            gameName = name;
            savePath = path;
            processName = proName;
            fileNames = sNames;
            usesSteamPath = useSteam;
        }
    }
}
